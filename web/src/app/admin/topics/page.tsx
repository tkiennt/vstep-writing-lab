    ...
    return (
      <div className="flex flex-col h-full bg-background items-center justify-center gap-4">
        <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-8 max-w-md text-center">
          <p className="text-red-400 font-bold text-lg mb-2">Failed to load topics</p>
          <p className="text-red-300/70 text-sm font-mono">{error}</p>
          <button
            onClick={fetchTopics}
            className="mt-4 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold rounded-xl transition-colors"
          >
            Retry
          </button>
        </div>
                        ...
                        <tr key={topic.questionId} className="hover:bg-muted/30 transition-colors group">
                          ...
                          <td className="px-6 py-4 text-right">
                             <div className="flex items-center justify-end gap-1">
                                ...
                                <Link href={`/admin/topics/create?id=${topic.questionId}`}>
